...
namespace EinzelneBeispiele.Extract_Method_Objekt
{
    ...
    /// </summary>
    public class ExtractMethodWtihTwoVariablesMiddle
    {
        ...
        public void printOwing()
        {
            ...
            while (e.Current>-1)
            {
                var ob = new CalculateInstandingOutstanding(this, instanding, outstanding);
                ob.compute(e);
    ...
    public class CalculateInstandingOutstanding
    {
        private ExtractMethodWtihTwoVariablesMiddle ExtractMethodWtihTwoVariablesMiddleField;
        public double instanding;
        public double outstanding;

        public CalculateInstandingOutstanding(ExtractMethodWtihTwoVariablesMiddle ExtractMethodWtihTwoVariablesMiddleObject, double instanding,
            double outstanding)
        {
        ...
        public void compute(IEnumerator<double> e)
        {
        ...
        private static int CalculateEach(IEnumerator<double> e)
        {
            return (int)e.Current + new Random().Next();
        }

        private double CalculateInstanding()
        {
            return  outstanding + new Random().Next();
        }
    }
}
